...
<body>
    ...
    <div class="container">
        ...
        <div class="filter">
            <button class="active" data-type="all">All <span style="opacity: 0.4;"><?php echo e($allCount); ?></span></button>
            <button data-type="note">Notes <span style="opacity: 0.4;"><?php echo e($notesCount); ?></span></button>
            <button data-type="quote">Quotes <span style="opacity: 0.4;"><?php echo e($quotesCount); ?></span></button>
            <button data-type="thought">Thoughts <span style="opacity: 0.4;"><?php echo e($thoughtsCount); ?></span></button>
        ...
        <div id="content">
            <?php $__empty_1 = true; $__currentLoopData = $items ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="item" data-type="<?php echo e($item['type'] ?? 'note'); ?>">
                    <div class="item-meta">
                        <?php echo e($item['date'] ?? 'Recent'); ?> 
                        &middot; 
                        <?php echo e(ucfirst($item['type'] ?? 'note')); ?>
                    ...
                    <div class="item-body">
                        ...
                        ?>
                        <a href="/view/<?php echo e($routeType); ?>/<?php echo e($item['slug'] ?? ''); ?>">
                            ...
                            <?php if(!empty($item['tags']) && is_array($item['tags'])): ?>
                                <div class="tags" style="margin-top: 0.75rem; display: flex; gap: 0.5rem; flex-wrap: wrap;">
                                    <?php $__currentLoopData = $item['tags']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="tag" data-tag="<?php echo e($tag); ?>" style="font-size: 0.8rem; color: #666; border: 1px solid #333; padding: 0.2rem 0.6rem; border-radius: 2px; cursor: pointer;"><?php echo e($tag); ?></span>
...
<?php /**PATH C:\wamp64\www\MidnightPilgrim\resources\views/read.blade.php ENDPATH**/ ?>