...
<body>
    ...
    <div class="container">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $clusters ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cluster): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="cluster">
                <div class="cluster-term"><?php echo e($cluster['term']); ?></div>
                
                <div class="references">
                    <?php $__currentLoopData = $cluster['references'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="reference" role="article">
                            <div class="reference-meta">
                                <a href="/<?php echo e($ref['type']); ?>/<?php echo e($ref['slug']); ?>" aria-label="View <?php echo e($ref['title'] ?? $ref['slug']); ?>">
                                    <?php echo e($ref['title'] ?? $ref['slug']); ?>

                                </a>
                                &middot;
                                <?php echo e($ref['date'] ?? 'Recent'); ?>

                            </div>
                            <div class="reference-excerpt">
                                <?php echo e($ref['excerpt']); ?>
...
<?php /**PATH C:\wamp64\www\MidnightPilgrim\resources\views/adjacent.blade.php ENDPATH**/ ?>